...
def main():
    ...
    tiro.TIRO_SPEED = pygame.USEREVENT + 7
    pygame.time.set_timer(tiro.TIRO_SPEED, 4000)
    tiro.TIRO_RECT_LIST = []

    # Boost de slow:
    slow_cancel = pygame.USEREVENT + 8
