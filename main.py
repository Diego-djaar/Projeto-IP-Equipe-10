...
def collision_sprite():
	...
	if pygame.sprite.spritecollide(player.sprite,planet_group,False):
		planet_group.empty()
		game_active = False
	if pygame.sprite.spritecollideany(player.sprite,boost_group): # checa colisão entre o jogador e os boosts
		boost_types = pygame.sprite.spritecollide(player.sprite,boost_group,True)
